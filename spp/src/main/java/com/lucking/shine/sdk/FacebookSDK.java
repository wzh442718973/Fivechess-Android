...
public class FacebookSDK {
            ...
            public void onCompleted(JSONObject object, GraphResponse response) {
                if(object != null) {
                    ...
                    try {
                        ...
                        NativeJavaClass.callJs("loginFaceBookSuccess", mJsonobjData.toString());
    ...
    public void loginResult(int code, String msg) {
        ...
        try {
            ...
            Toast.makeText(MainActivity.g_this, msg, Toast.LENGTH_LONG).show();
    ...
    public void shareUrl(String Url, String Des) {
        //insert code

        if(Url != null) {
            if(ShareDialog.canShow(ShareLinkContent.class)) {
                ShareLinkContent linkContent = new ShareLinkContent.Builder().setContentUrl(Uri.parse(Url)).setQuote(Des).build();
    ...
    private void GetTime(MainActivity activity) {
        //insert code

        preferences = activity.getSharedPreferences("IpAndPort", MainActivity.MODE_PRIVATE);
